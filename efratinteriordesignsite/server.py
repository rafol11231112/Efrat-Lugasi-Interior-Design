...
class CustomHandler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == '/api/design-styles':
            styles = [
                {
                    "id": "modern",
                    "name": "Modern",
                ...
                },
                {
                    "id": "contemporary",
                    "name": "Contemporary",
                    "description": "Current and evolving, blending styles with a sophisticated feel. Features bold colors and unique artistic elements.",
                    "colors": ["#000000", "#FFFFFF", "#FF4500", "#4682B4"],
                    "image": "/images/styles/contemporary.jpg"
                },
                {
                    "id": "coastal",
                    "name": "Coastal",
                    "description": "Beach-inspired design with light colors, natural textures, and nautical elements.",
                    "colors": ["#87CEEB", "#FFFFFF", "#DEB887", "#4682B4"],
                    "image": "/images/styles/coastal.jpg"
                },
                {
                    "id": "rustic",
                    "name": "Rustic",
                    "description": "Natural and weathered elements with a focus on organic materials and textures.",
                    "colors": ["#8B4513", "#A0522D", "#F5DEB3", "#556B2F"],
